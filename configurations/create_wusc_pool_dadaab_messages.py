...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    pipeline_name="CREATE-DADAAB-WUSC-POOL",
        ...
        RapidProSource(
            ...
            sync_config=RapidProToEngagementDBConfiguration(
                flow_result_configurations=[
                    ...
                    FlowResultConfiguration("wusc_keep_ii_dadaab_demogs", "age", "dadaab_age"),
                    FlowResultConfiguration("wusc_keep_ii_dadaab_demogs", "location", "dadaab_location"),
                    FlowResultConfiguration("wusc_keep_ii_dadaab_demogs", "nationality", "dadaab_nationality"),
                    FlowResultConfiguration("wusc_keep_ii_dadaab_demogs", "gender", "dadaab_gender"),

                    FlowResultConfiguration("wusc_covid19_adaptation_dadaab_demogs", "household_language",
                                            "dadaab_household_language"),
                    FlowResultConfiguration("wusc_covid19_adaptation_dadaab_demogs", "age", "dadaab_age"),
                    FlowResultConfiguration("wusc_covid19_adaptation_dadaab_demogs", "location", "dadaab_location"),
                    FlowResultConfiguration("wusc_covid19_adaptation_dadaab_demogs", "nationality", "dadaab_nationality"),
                    FlowResultConfiguration("wusc_covid19_adaptation_dadaab_demogs", "gender", "dadaab_gender"),

                    FlowResultConfiguration("wusc_keep_ii_s03_dadaab_demogs", "household_language",
                                            "dadaab_household_language"),
                    FlowResultConfiguration("wusc_keep_ii_s03_dadaab_demogs", "age", "dadaab_age"),
                    FlowResultConfiguration("wusc_keep_ii_s03_dadaab_demogs", "location", "dadaab_location"),
                    FlowResultConfiguration("wusc_keep_ii_s03_dadaab_demogs", "nationality", "dadaab_nationality"),
                    FlowResultConfiguration("wusc_keep_ii_s03_dadaab_demogs", "gender", "dadaab_gender")
                ]
            )
        ),
    ],
        ...
        sync_config=CodaSyncConfiguration(
            dataset_configurations=[
                CodaDatasetConfiguration(
                    ...
                    engagement_db_dataset="dadaab_gender",
                ...
                CodaDatasetConfiguration(
                    ...
                    engagement_db_dataset="dadaab_location",
                    code_scheme_configurations=[
                ...
                CodaDatasetConfiguration(
                    ...
                    engagement_db_dataset="dadaab_household_language",
                    code_scheme_configurations=[
                ...
                CodaDatasetConfiguration(
                    ...
                    engagement_db_dataset="dadaab_age",
                    code_scheme_configurations=[
                ...
                CodaDatasetConfiguration(
                    ...
                    engagement_db_dataset="dadaab_nationality",
                    code_scheme_configurations=[
